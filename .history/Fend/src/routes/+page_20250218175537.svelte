<script lang="ts">
	...
	import type { SimulationState, RoadCategory, IntersectionType } from '$lib/types';

	// Define the Tool type as union of road categories and intersection types
	type Tool = RoadCategory | keyof IntersectionType;

	// Initialize with a valid tool value
	let selectedTool: Tool = 'local';
